...
- **Administrative Data Management:** Endpoints for browsing, synchronizing, and deleting captured images and associated sensor data. Includes **soft-deletion** for all image removal actions (manual and automated), moving files to a **trash recovery system** and audit logging all actions for potential restoration.
