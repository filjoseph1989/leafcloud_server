...
# ==========================================
# CONFIGURATION - MULTI-TASK V9
# ==========================================
DB_URL = settings.DATABASE_URL
IMG_SIZE = (224, 224)
BATCH_SIZE = 32
TIMESTAMP = datetime.now().strftime('%Y%m%d_%H%M')
MODEL_SAVE_PATH = f'leafcloud_multimodal_v9_{TIMESTAMP}.keras'
...
if __name__ == '__main__':
    ...
    if train_df.empty:
        ...
        print('🧠 Building Multi-Task Multi-Modal Model (V9)...')
        model, base_model = build_model_v9()
        model.summary()
