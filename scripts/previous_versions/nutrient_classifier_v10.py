...
# ==========================================
# CONFIGURATION - MULTI-TASK V10
# ==========================================
DB_URL = settings.DATABASE_URL
IMG_SIZE = (224, 224)
BATCH_SIZE = 32
TIMESTAMP = datetime.now().strftime('%Y%m%d_%H%M')
MODEL_SAVE_PATH = f'leafcloud_multimodal_v10_{TIMESTAMP}.keras'
...
def calculate_continuous_targets(df: pd.DataFrame) -> pd.DataFrame:
    ...
    """
    print('\n📈 Calculating continuous time-based depletion targets (V10)...')
...
def build_model_v10():
    ...
    # Batch Normalization normalizes features for comparable scaling
    ...
    # Gradient Isolation Layers
    # Completely stop regression gradients from flowing back into shared layers
...
if __name__ == '__main__':
    ...
    if train_df.empty:
        ...
        print('🧠 Building Multi-Task Multi-Modal Model (V10)...')
        model, base_model = build_model_v10()
        model.summary()
